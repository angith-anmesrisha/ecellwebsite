...
import { ArrowUpRight, Sparkles, Users, Skull, Calendar, LineChart } from "lucide-react";
...
export default function Home() {
  ...
  const smoothBackgroundY = useSpring(backgroundY, { stiffness: 100, damping: 20 });
  ...
  return (
    <>
      ...
      <div ref={containerRef} className="relative min-h-[200vh] text-white overflow-hidden bg-transparent w-full">
        ...
        <motion.div style={{ y: smoothBackgroundY }} className="absolute inset-0 max-w-7xl mx-auto w-full h-full pointer-events-none px-6 md:px-10 z-0">
          <div className="w-full h-full relative border-x border-white/[0.04]">
            <AnimatedGridLine orientation="vertical" className="left-1/3 hidden lg:block" />
            <AnimatedGridLine orientation="vertical" className="left-2/3 hidden lg:block" />
          </div>
        </motion.div>
        ...
        <main className="relative z-10 flex flex-col pt-44 sm:pt-48 pb-32 overflow-visible">
          ...
          <div className="flex-1 flex flex-col lg:flex-row items-center justify-between px-6 md:px-10 max-w-7xl mx-auto w-full gap-16 relative z-10">
            <div className="flex-1 space-y-8 text-center lg:text-left z-20 w-full">
              <motion.p 
              ...
              <MasterMagnet radius={300} pull={0.4}>
                <h1 className="text-6xl sm:text-8xl md:text-9xl font-black tracking-tighter leading-[0.85] block text-left uppercase pointer-events-none overflow-visible w-full select-none">
                  <span className="text-white block relative z-10" style={{ textShadow: "0 10px 30px rgba(0,0,0,0.7)" }}>
                    WE HELP YOU
                  </span>
                  <AnimatedWord />
                </h1>
            ...
            <motion.div 
              ...
              className="flex-1 flex justify-center items-center scale-75 md:scale-100 z-20 lg:border-l border-white/[0.04] py-8 lg:py-16 w-full"
            >
              <RotatingBadge />
            </motion.div>
          </div>
        ...
        <section id="ai-feed" className="relative z-40 py-28 bg-black/20 backdrop-blur-md">
          <ScrollReveal>
            <div className="text-center mb-16">
              ...
              <MasterMagnet radius={150} pull={0.25}>
                <h2 className="text-3xl md:text-5xl font-black text-white tracking-tight mt-1 uppercase pointer-events-none">
                  What's Happening in Innovation Today
                </h2>
              </MasterMagnet>
            </div>
              ...
              <div className="space-y-3">
                ...
                <MasterMagnet radius={180} pull={0.25}>
                  <h2 className="text-4xl md:text-5xl font-black tracking-tight uppercase pointer-events-none">
                    ...
                    <span className="text-purple-500">Ecosystem</span>
                  </h2>
                </MasterMagnet>
        ...
        <section id="team" className="relative z-10 py-32 max-w-7xl mx-auto px-6 md:px-10">
          <ScrollReveal>
            <div className="mb-20">
              <KineticTextReveal 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 perspective-1000">
            <ScrollReveal delay={0.05}>
              <TeamCard name="Don Joe" role="Technical Head" imagePath="/team/a.jpg" />
            </ScrollReveal>
            <ScrollReveal delay={0.15}>
              <TeamCard name="Jane Doe" role="President" imagePath="/team/jane.jpg" />
            </ScrollReveal>
            <ScrollReveal delay={0.25}>
              <TeamCard name="John Smith" role="Operations Head" imagePath="/team/john.jpg" />
            </ScrollReveal>
          </div>
        </section>
        
        <section id="simulator" className="relative z-10 py-32 bg-zinc-950/10 backdrop-blur-2xs">
            ...
            <div className="w-full bg-zinc-950/40 backdrop-blur-xs border border-white/10 rounded-2xl p-8 md:p-14 relative overflow-hidden flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 group hover:border-purple-500/20 transition-all duration-500">
              ...
              <div className="space-y-3 max-w-2xl">
                ...
                <h3 className="text-2xl md:text-4xl font-black tracking-tight text-white uppercase leading-tight">
                  Shape the Future of Campus Entrepreneurship
                </h3>
              ...
              <Link href="/recruitment" className="w-full lg:w-auto shrink-0 z-20">
                <MagneticComponent>
                  <button className="w-full lg:w-auto px-8 py-4 bg-white text-black text-xs font-bold uppercase tracking-widest rounded-xl transition-all flex items-center justify-center gap-2 hover:bg-purple-500 hover:text-white duration-300 shadow-2xl">
                    <span>Enter Application Portal</span>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex justify-between items-center text-[10px] font-bold tracking-wider uppercase pt-4 border-t border-white/5 relative z-10 translate-z-0 group-hover:translate-z-6 transition-transform duration-500 ease-[0.16,1,0.3,1] pointer-events-none">
